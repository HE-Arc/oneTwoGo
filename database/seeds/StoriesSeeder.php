    ...
    public function run()
    {
      $id = DB::table('stories')->insertGetId(
        [
          ...
          Il demanda a son petit fils : "Petit, va donc chercher pour ton héros une part de tarte aux pommes, elle sent tellement bon, ce serai certainement un de mes derniers plaisir avant de mourir... "
